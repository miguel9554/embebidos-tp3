...
#define RED_GPIO_PORT_NUM                       2
#define RED_GPIO_BIT_NUM                        0
#define GREEN_GPIO_PORT_NUM                     2
#define GREEN_GPIO_BIT_NUM                      1
#define BUTTONS_BUTTON2_GPIO_PORT_NUM           1
#define BUTTONS_BUTTON2_GPIO_BIT_NUM            31
...
static void Board_LED_Init(void)
{
	...
	/* Set the PI2_0 as output */
	Chip_GPIO_WriteDirBit(LPC_GPIO, RED_GPIO_PORT_NUM, RED_GPIO_BIT_NUM, true);
	/* Set the PI2_1 as output */
	Chip_GPIO_WriteDirBit(LPC_GPIO, GREEN_GPIO_PORT_NUM, GREEN_GPIO_BIT_NUM, true);
}
...
void Board_LED_Set(uint8_t LEDNumber, bool On)
{
	...
	if (LEDNumber == 1) {
		Chip_GPIO_WritePortBit(LPC_GPIO, RED_GPIO_PORT_NUM, RED_GPIO_BIT_NUM, On);
	}
	if (LEDNumber == 2) {
		Chip_GPIO_WritePortBit(LPC_GPIO, GREEN_GPIO_PORT_NUM, GREEN_GPIO_BIT_NUM, On);
	}
}
...
bool Board_LED_Test(uint8_t LEDNumber)
{
	...
	if (LEDNumber == 1) {
		state = Chip_GPIO_ReadPortBit(LPC_GPIO, RED_GPIO_PORT_NUM, RED_GPIO_BIT_NUM);
	}
	if (LEDNumber == 2) {
		state = Chip_GPIO_ReadPortBit(LPC_GPIO, GREEN_GPIO_PORT_NUM, GREEN_GPIO_BIT_NUM);
	}
	return state;
}
